                ...
                <div class="tab-pane active" id="tab1" role="tabpanel">
                                                ...
                                                <div class="panel-body">
                                                    <div class="col-md-12 panelTop">
                                                        ...
                                                        <div class="col-md-6">
                                                            ...
                                                            <br>
                                                            <h4>Price<span class="itemPrice"> $24.99</span></h4>
                                                            <h4>Phone<span class="itemPhone"> (147)852-369</span></h4>
                                                            <h4>Email<span class="itemEmail"> name@example.com</span></h4>
                                                        </div>
                                                    </div>
                                                </div>
                                            </div>
                    ...
                    <div class="col-sm-3 col-lg-3 col-md-3">
                        <div class="thumbnail">
                            ...
                            <div class="caption">
                                <h4 class="pull-right"><span class="itemPrice2">$64.99</span></h4>
                                <h4><a href="#myModal" data-toggle="modal" data-target=".bs-example-modal-lg">Product name</a>
                                </h4>
